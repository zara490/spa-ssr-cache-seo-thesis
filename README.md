<p align="center">
   <a href="https://shadcnstudio.com/templates/zolt-portfolio-template-free" target="_blank">
      <img src="https://cdn.shadcnstudio.com/ss-assets/template/landing-page/zolt/logo.png" alt="zolt-logo" width="32px" height="32px">
   </a>
</p>

<h1 align="center">
   <a href="https://shadcnstudio.com/templates/zolt-portfolio-template-free" target="_blank" align="center">
      Zolt - Shadcn UI Portfolio Landing Page Template - Free
   </a>
</h1>

![GitHub](https://img.shields.io/github/license/shadcnstudio/shadcn-nextjs-zolt-landing-page-free) ![GitHub issues](https://img.shields.io/github/issues/shadcnstudio/shadcn-nextjs-zolt-landing-page-free) ![GitHub closed issues](https://img.shields.io/github/issues-closed/shadcnstudio/shadcn-nextjs-zolt-landing-page-free) ![Twitter Follow](https://img.shields.io/twitter/follow/ShadcnStudio?style=social)

<kbd>[![Zolt - Shadcn UI Portfolio Landing Page Template Demo Screenshot](https://cdn.shadcnstudio.com/ss-assets/template/landing-page/zolt/og-image.png)](https://shadcnstudio.com/templates/zolt-portfolio-template-free)</kbd>
...
[View Demo](https://shadcnstudio.com/preview/templates/shadcn-nextjs-zolt-landing-page)
...
- **Homepage** - Hero introduction, about, featured works, experience timeline, services, testimonials, and a service booking flow
- **Case Study Detail** - Full-width project page with MDX support, reading progress indicator, project meta (organisation, role, duration, tools), and other works suggestions
- **Contact Page** - Ready-to-use contact form paired with featured works, services, and testimonials to build trust

**Key UI Sections**

- **Hero Section** - Animated greeting and headline that sets the tone for your portfolio
- **About** - Personal introduction with profile carousel, music player, and trip/note cards for a personal touch
- **Featured Works** - Showcase your best case studies in a grid or vertical layout
- **Experience Timeline** - Highlight your work history and activity with a timeline of roles
- **Services** - Present the services you offer to potential clients
- **Testimonials** - Build credibility with client feedback and reviews
- **Select Service / Hire Me** - A guided booking flow for prospects to choose a service, pick a time, and get in touch
- **Footer & Nav Dock** - Social links and a floating navigation dock for quick access across the site
